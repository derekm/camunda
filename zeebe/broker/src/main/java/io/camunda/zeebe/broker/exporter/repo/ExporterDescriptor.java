...
public class ExporterDescriptor {
  ...
  public ExporterDescriptor(
    ...
    this.exporterFactory = Objects.requireNonNullElseGet(exporterFactory, () -> getDefaultExporterFactory(id));
  }
  ...
  private @NotNull ExporterFactory getDefaultExporterFactory(String id) {
